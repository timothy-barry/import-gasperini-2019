...
intermediate_data_dir <- paste0(gasp_offsite, "pilot/intermediate/")
if (!dir.exists(intermediate_data_dir)) dir.create(path = intermediate_data_dir, recursive = TRUE)
raw_data_dir <- paste0(gasp_offsite, "pilot/raw/")
processed_data_dir <- paste0(gasp_offsite, "pilot/processed/")
...
saveRDS(object = perturbations, file = paste0(intermediate_data_dir, "/perturbations.rds"))
